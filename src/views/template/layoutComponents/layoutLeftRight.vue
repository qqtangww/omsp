              ...
              <el-row>
                ...
                <el-col :span="10">
                  <div class="imgeLayout">
                    <img src="@/assets/images/templateImg/left-right.png" alt />
                  </div>
          ...
          <div class="layoutRegionalBox">
            <div class="configTitle">
              ...
              <div class="treeDataShow">
                <el-form-item label="依赖响应区域" label-width="110px" prop="i_DefaultResRegin">
                ...
                <el-form-item label="区域标题" label-width="110px" prop="v_regionalTitle">
                  <el-input v-model="region1.v_regionalTitle"></el-input>
                </el-form-item>
                <el-form-item label="标题样式" label-width="110px" prop="v_titleColor">
                  <el-select
                ...
                <el-form-item label="数值单位" label-width="110px" prop="v_DefaultUnit">
                ...
                <el-row>
                  <el-col :span="12">
                    <el-form-item label="默认宽度" label-width="110px">
                      <el-input-number
            ...
            <div class="configTitle">
              ...
              <div class="treeDataShow">
                ...
                <el-form-item label="区域标题" label-width="110px">
                ...
                <el-form-item label="内容名称" label-width="110px" v-if="cateCodeName2 === 'CT'">
                ...
                <el-form-item label="最小宽度" label-width="110px">
...
export default {
  ...
  created () {
    ...
    if (confsBtn.operationcode === 'modify') {
      ...
      let currentTab = Object.assign({}, this.modAddData, { code: this.modAddData.v_RegionCode }, { v_ComponentType: 'CR_LF' })
        ...
        if (valid) {
          ...
          cgiService.saveLayoutInstance(this.modAddData).then(res => {
            if (res.code === 0) {
              ...
              this.$emit('getTableData', params['CC_VW_instanceleftRight'])
              // 把修改的数据存入vuex中  方便返回给其他的Tab页【方便组参数保存调取数据】
              let currentTab = Object.assign({}, this.modAddData, { code: this.modAddData.v_RegionCode }, { v_ComponentType: 'CR_LF' })
              this.$set(currentTab, 'regin', 'regin1')
              this.$store.commit('changeRepetitionRowTabData', currentTab)
