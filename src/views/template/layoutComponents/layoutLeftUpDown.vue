          ...
          <div class="layoutRegionalBox">
            <div class="configTitle">
              ...
              <div class="treeDataShow">
                <el-form-item label="依赖响应区域" label-width="100px" prop="i_DefaultResRegin">
            ...
            <div class="configTitle">
              ...
              <div class="treeDataShow">
                ...
                <el-form-item label="内容名称" label-width="100px" v-if="cateCodeName2 === 'CT'">
                  <el-input v-model="region2.v_contentName" @input="change"></el-input>
                </el-form-item>
                <el-form-item label="数值单位" label-width="100px" prop="v_DefaultUnit">
                ...
                <el-row>
                  <el-col :span="12">
                    <el-form-item label="默认高度" label-width="100px">
                      <el-input-number
                        v-model="region2.v_DefaultHeight"
                        controls-position="right"
                        :min="0"
                      ></el-input-number>
                    </el-form-item>
                ...
                <el-row>
                  <el-col :span="12">
                    <el-form-item label="默认宽度" label-width="100px">
                      <el-input-number
                        v-model="region2.v_DefaultWidth"
                        controls-position="right"
                        :min="0"
                        disabled
                      ></el-input-number>
            ...
            <div class="configTitle">
              ...
              <div class="treeDataShow">
                ...
                <el-form-item label="内容名称" label-width="100px" v-if="cateCodeName3 === 'CT'">
                  <el-input v-model="region3.v_contentName" @input="change"></el-input>
                </el-form-item>
                <el-form-item label="数值单位" label-width="100px" prop="v_DefaultUnit">
...
export default {
  ...
  created () {
    ...
    if (confsBtn.operationcode === 'modify') {
      ...
      let currentTab = Object.assign({}, this.modAddData, { code: this.modAddData.v_RegionCode }, { v_ComponentType: 'CR_LUD' })
        ...
        if (valid) {
          ...
          cgiService.saveLayoutInstance(this.modAddData).then(res => {
            if (res.code === 0) {
              ...
              this.$emit('getTableData', params['CC_VW_instanceLeftUpDown'])
              // 把修改的数据存入vuex中  方便返回给其他的Tab页【方便组参数保存调取数据】
              let currentTab = Object.assign({}, this.modAddData, { code: this.modAddData.v_RegionCode }, { v_ComponentType: 'CR_LUD' })
              this.$set(currentTab, 'regin', 'regin1')
              this.$store.commit('changeRepetitionRowTabData', currentTab)
