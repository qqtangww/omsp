              ...
              <el-row>
                ...
                <el-col :span="10">
                  <div class="imgeLayout">
                    <img src="@/assets/images/templateImg/left-center-right.png" alt />
                  </div>
...
export default {
  ...
  created () {
    ...
    if (confsBtn.operationcode === 'modify') {
      ...
      let currentTab = Object.assign({}, this.modAddData, { code: this.modAddData.v_RegionCode }, { v_ComponentType: 'CR_LMR' })
        ...
        if (valid) {
          ...
          cgiService.saveLayoutInstance(this.modAddData).then(res => {
            if (res.code === 0) {
              ...
              this.$emit('getTableData', params['CC_VW_instanceleftCenterRight'])
