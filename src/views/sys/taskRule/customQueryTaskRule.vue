        ...
        <el-row>
          <el-col :span='6'>
            <el-form-item label-width="110px" label="任务规则类型：">
              <el-select placeholder="请选择" v-model="formSearch.v_TemplateType" clearable>
                <el-option
          ...
          <el-col :span='6'>
            <el-form-item label-width="110px" label="任务规则编码：">
              <el-input v-model="formSearch.v_TemplateCode" placeholder="请输入任务规则编码" clearable @keydown.enter.native="onSubmit"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span='7'>
            <el-form-item label-width="110px" label="任务规则名称">
              <el-input v-model="formSearch.v_TemplateName" placeholder="请输入任务规则名称" clearable @keydown.enter.native="onSubmit"></el-input>
            </el-form-item>
          </el-col>
...
export default {
  ...
  methods: {
    onSubmit () {
      // 需要查询的字段
      let queryKeyObj = {
        v_TemplateName: 't_sys_task_rule_base.v_TaskRuleName',
        v_TemplateType: 't_sys_task_rule_base.v_TaskRuleType',
        v_TemplateCode: 't_sys_task_rule_base.v_TaskRuleCode'
      }
