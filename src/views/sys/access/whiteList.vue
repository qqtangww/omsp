<template>
  <div class="add-modify-form" id="white-list">
                ...
                <el-table-column prop="name" label="允许IP地址/段">
                  <template slot-scope="scope">
                    ...
                    <div class="editBoxInput" v-if="scope.row.i_Id === editID">
                      ...
                      <el-input v-if="scope.row.v_EndIP" :maxlength="4" v-model="editBIPFive"></el-input>
                      <el-input v-if="scope.row.v_EndIP" :maxlength="4" v-model="editBIPSix"></el-input>
                      <el-input v-if="scope.row.v_EndIP" :maxlength="4" v-model="editBIPSeven"></el-input>
                      <el-input v-if="scope.row.v_EndIP" :maxlength="4" v-model="editBIPEight"></el-input>
                    </div>
                  </template>
                </el-table-column>
...
export default {
  ...
  watch: {
    currentOperation (nVal) {
      if (nVal.indexOf('addWhiteIPList') !== -1) {
        this.IPDBox = true
        this.IPBox = false
        this.MACBox = false
      } else if (nVal.indexOf('addWhiteIP') !== -1) {
        this.IPBox = true
        this.IPDBox = false
        this.MACBox = false
      } else if (nVal.indexOf('addWhiteMAC') !== -1) {
        this.MACBox = true
        this.IPBox = false
        this.IPDBox = false
      }
...
#white-list{
  ...
  .white-ip-table,.white-mac-table{
    border: 1px solid #E6E6E6;
  }
  #white-ip-pagination,#white-mac-pagination{
