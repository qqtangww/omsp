 ...
 * @LastEditTime: 2019-09-19 17:27:00
...
<template>
  <div class='add-org-form'>
    ...
    <el-form inline-message ref="metaForm" :model="metaForm" :rules="rules" label-width="100px" id="form-org-parameter">
      ...
      <div id="border-box">
          <el-row class="box-head">
            <el-col :span="4" :push='2'><div>参数值</div></el-col>
            <el-col :span="7" :push='5'><div>系统</div></el-col>
            <el-col :span="7" :push='7'><div>当前组参数</div></el-col>
          </el-row>
          <!-- 默认 -->
          <div v-if="noFlag" id="no-conBox">
            <el-row >
              <el-form-item label="值1" label-width="90px" prop="v_ParamValue">
              <el-col :span="10" :push='2'><div><el-input placeholder="" :value="sysMetaForm.v_ParamValue === '' ? '/' : sysMetaForm.v_ParamValue" :disabled="true"></el-input></div></el-col>
              <el-col :span="10" :push='3'><div><el-input placeholder="" v-model="metaForm.v_ParamValue"></el-input></div></el-col>
              </el-form-item>
            </el-row>
            <el-row >
              <el-form-item label="值2" label-width="90px">
              <el-col :span="10" :push='2'><div><el-input placeholder="" :value="sysMetaForm.v_ParamValue1 === '' ? '/' : sysMetaForm.v_ParamValue1" :disabled="true"></el-input></div></el-col>
              <el-col :span="10" :push='3'><div><el-input placeholder="" v-model="metaForm.v_ParamValue1"></el-input></div></el-col>
              </el-form-item>
            </el-row>
            <el-row >
              <el-form-item label="值3" label-width="90px">
              <el-col :span="10" :push='2'><div><el-input placeholder="" :value="sysMetaForm.v_ParamValue2 === '' ? '/' : sysMetaForm.v_ParamValue2" :disabled="true"></el-input></div></el-col>
              <el-col :span="10" :push='3'><div><el-input placeholder="" v-model="metaForm.v_ParamValue2"></el-input></div></el-col>
              </el-form-item>
            </el-row>
            <el-row >
              <el-form-item label="值4" label-width="90px">
              <el-col :span="10" :push='2'><div><el-input placeholder="" :value="sysMetaForm.v_ParamValue3 === '' ? '/' : sysMetaForm.v_ParamValue3" :disabled="true"></el-input></div></el-col>
              <el-col :span="10" :push='3'><div><el-input placeholder="" v-model="metaForm.v_ParamValue3"></el-input></div></el-col>
              </el-form-item>
            </el-row>
            <el-row >
              <el-form-item label="值5" label-width="90px">
              <el-col :span="10" :push='2'><div><el-input placeholder="" :value="sysMetaForm.v_ParamValue4 === '' ? '/' : sysMetaForm.v_ParamValue4" :disabled="true"></el-input></div></el-col>
              <el-col :span="10" :push='3'><div><el-input placeholder="" v-model="metaForm.v_ParamValue4"></el-input></div></el-col>
              </el-form-item>
            </el-row>
          </div>
          <!-- 数字类型 -->
...
export default {
  ...
  data () {
    ...
    return {
      ...
      rules: {
        ...
        v_ParamValue: [
          { required: true, message: '请输入参数组值1', trigger: 'blur' }
        ]
      },
      formRed: false,
      noFlag: true,
  ...
  created () {
    ...
    if (confsBtn.operationcode === 'modify') {
      ...
      this.selectParentVal1(formData.v_ParamCode)
    }
    this.oldModAddData = Object.assign({}, this.metaForm)
  },
  methods: {
    commit () {
      let formData = this.$store.state.fieRowTableData['CC_VW_parameterGroup']
      let params = {
        v_GroupCode: formData.v_GroupCode,
        v_ParamCode: this.metaForm.v_ParamCode,
        // i_BizID: this.metaForm.i_BizID,
        v_ParamName: this.metaForm.v_ParamName,
        v_ParamValue: this.metaForm.v_ParamValue,
        v_ParamValue1: this.metaForm.v_ParamValue1,
        v_ParamValue2: this.metaForm.v_ParamValue2,
        v_ParamValue3: this.metaForm.v_ParamValue3,
        v_ParamValue4: this.metaForm.v_ParamValue4
      }
      if (this.v_EnumCode === '') {
      ...
      if (this.metaForm.i_Id) {
        this.$set(params, 'i_Id', this.metaForm.i_Id)
      }
      this.$refs.metaForm.validate(valid => {
        if (valid) {
          ...
          cgiService.saveParameterGrpList(params).then(res => {
            if (res.code === 0) {
              this.formRed = false
              if (res.iId > 1) {
    ...
    selectParentVal (id) {
      ...
      cgiService.getOneSysParameter(params).then(res => {
        if (res.code === 0) {
          ...
          this.metaForm.i_BizID = data.i_BizID
          ...
          // cgiService.getTemEnumValList(this.v_EnumCode).then(res => {
    ...
    // 获取系统参数
    getParameterSysList () {
      cgiService.getParamSysList().then(res => {
        if (res.code === 0) {
