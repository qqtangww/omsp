<!-- 参数管理接口参数自定义查询 -->
<template>
  <div class="parameter-custom-api-query">
...
.parameter-custom-api-query /deep/.el-date-editor .el-range__icon {
    line-height: 24px;
}
.parameter-custom-api-query /deep/ .el-form-item__content .el-range-editor{
  width: 100%
}
</style>
