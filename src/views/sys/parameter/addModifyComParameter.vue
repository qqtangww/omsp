    ...
    >
      <div class="border-box">
        ...
        <div class="conBox">
          ...
          <!-- <el-form-item label="适用类型" prop="v_ComponentType">
            <el-input
              :disabled="isDisableOrg"
          ...
          <el-form-item label="适用组件实例编码">
            <el-input
              :disabled="isDisableOrg"
              v-model="componentType.v_Code"
              placeholder="可填写数字，英文,下划线组成"
            />
          </el-form-item>
        ...
        <div v-if="noFlag" id="no-conBox">
          <el-row>
            <el-form-item label="值1" label-width="90px" prop="v_ParamValue">
              ...
              <el-col :span="10" :push="3">
                <div>
                  <el-input placeholder v-model="metaForm.v_ParamValue" :disabled="true"></el-input>
                </div>
              </el-col>
            </el-form-item>
          </el-row>
          <el-row>
            <el-form-item label="值2" label-width="90px">
              ...
              <el-col :span="10" :push="3">
                <div>
                  <el-input placeholder v-model="metaForm.v_ParamValue1" :disabled="true"></el-input>
                </div>
              </el-col>
            </el-form-item>
          </el-row>
          <el-row>
            <el-form-item label="值3" label-width="90px">
              ...
              <el-col :span="10" :push="3">
                <div>
                  <el-input placeholder v-model="metaForm.v_ParamValue2" :disabled="true"></el-input>
                </div>
              </el-col>
            </el-form-item>
          </el-row>
          <el-row>
            <el-form-item label="值4" label-width="90px">
              ...
              <el-col :span="10" :push="3">
                <div>
                  <el-input placeholder v-model="metaForm.v_ParamValue3" :disabled="true"></el-input>
                </div>
              </el-col>
            </el-form-item>
          </el-row>
          <el-row>
            <el-form-item label="值5" label-width="90px">
              ...
              <el-col :span="10" :push="3">
                <div>
                  <el-input placeholder v-model="metaForm.v_ParamValue4" :disabled="true"></el-input>
                </div>
              </el-col>
            </el-form-item>
          </el-row>
              ...
              <el-col :span="10" :push="5">
                <div>
                  <el-input-number
                    ...
                    :value="sysMetaForm.v_ParamValue === null ? undefined : sysMetaForm.v_ParamValue"
            ...
            <el-form-item label="值2" label-width="90px">
              <el-col :span="10" :push="5">
                <div>
                  <el-input-number
                    controls-position="right"
                    :value="sysMetaForm.v_ParamValue1 === null ? undefined : sysMetaForm.v_ParamValue1"
                    :min="Number(sysMetaForm.i_MinNumber)"
                    :max="Number(sysMetaForm.i_MaxNumber)"
                    label
                    :disabled="true"
            ...
            <el-form-item label="值3" label-width="90px">
              <el-col :span="10" :push="5">
                <div>
                  <el-input-number
                    controls-position="right"
                    :value="sysMetaForm.v_ParamValue2 === null ? undefined : sysMetaForm.v_ParamValue2"
                    :min="Number(sysMetaForm.i_MinNumber)"
                    :max="Number(sysMetaForm.i_MaxNumber)"
                    label
                    :disabled="true"
            ...
            <el-form-item label="值4" label-width="90px">
              <el-col :span="10" :push="5">
                <div>
                  <el-input-number
                    controls-position="right"
                    :value="sysMetaForm.v_ParamValue3 === null ? undefined : sysMetaForm.v_ParamValue3"
                    :min="Number(sysMetaForm.i_MinNumber)"
                    :max="Number(sysMetaForm.i_MaxNumber)"
                    label
                    :disabled="true"
            ...
            <el-form-item label="值5" label-width="90px">
              <el-col :span="10" :push="5">
                <div>
                  <el-input-number
                    controls-position="right"
                    :value="sysMetaForm.v_ParamValue4 === null ? undefined : sysMetaForm.v_ParamValue4"
                    :min="Number(sysMetaForm.i_MinNumber)"
                    :max="Number(sysMetaForm.i_MaxNumber)"
                    label
                    :disabled="true"
              ...
              <el-col :span="10" :push="4">
                <div>
                  <span class="default-color">
                    <el-color-picker size="small" :predefine="colorList" @change='changeColor1'  v-model="metaForm.v_ParamValue" :disabled="true"></el-color-picker>
                  </span>
                  <span>
                    <el-color-picker size="small" :predefine="colorList" @change='changeColor2'  v-model="paramValue.v_ParamValue.color2" :disabled="true"></el-color-picker>
                  </span>
                  <div id="deg-input">
                    <el-input v-model="paramValue.v_ParamValue.deg" @change='changeColor3' placeholder="度数" :disabled="true"/>
                  </div>
          ...
          <el-row>
            <el-form-item label="值2" label-width="90px">
              ...
              <el-col :span="8" :push="4">
                <div>
                  <span class="default-color">
                    <el-color-picker size="small" :predefine="colorList" @change='changeColor4'  v-model="paramValue.v_ParamValue1.color1" :disabled="true"></el-color-picker>
                  </span>
                  <span>
                    <el-color-picker size="small" :predefine="colorList" @change='changeColor5'  v-model="paramValue.v_ParamValue1.color2" :disabled="true"></el-color-picker>
                  </span>
                  <div id="deg-input">
                    <el-input v-model="paramValue.v_ParamValue1.deg" @change='changeColor6' placeholder="度数" :disabled="true"/>
                  </div>
          ...
          <el-row>
            <el-form-item label="值3" label-width="90px">
              ...
              <el-col :span="10" :push="4">
                <div>
                  <span class="default-color">
                    <el-color-picker size="small" :predefine="colorList" @change='changeColor7' v-model="paramValue.v_ParamValue2.color1" :disabled="true"></el-color-picker>
                  </span>
                  <span>
                    <el-color-picker size="small" :predefine="colorList" @change='changeColor8'  v-model="paramValue.v_ParamValue2.color2" :disabled="true"></el-color-picker>
                  </span>
                  <div id="deg-input">
                    <el-input v-model="paramValue.v_ParamValue2.deg" @change='changeColor9' placeholder="度数" :disabled="true"/>
                  </div>
          ...
          <el-row>
            <el-form-item label="值4" label-width="90px">
              ...
              <el-col :span="10" :push="4">
                <div>
                  <span class="default-color">
                    <el-color-picker size="small" :predefine="colorList" @change='changeColor10' v-model="paramValue.v_ParamValue3.color1" :disabled="true"></el-color-picker>
                  </span>
                  <span>
                    <el-color-picker size="small" :predefine="colorList" @change='changeColor11'  v-model="paramValue.v_ParamValue3.color2" :disabled="true"></el-color-picker>
                  </span>
                  <div id="deg-input">
                    <el-input v-model="paramValue.v_ParamValue3.deg" @change='changeColor12' placeholder="度数" :disabled="true"/>
                  </div>
          ...
          <el-row>
            <el-form-item label="值5" label-width="90px">
              ...
              <el-col :span="10" :push="4">
                <div>
                  <span class="default-color">
                    <el-color-picker size="small" :predefine="colorList" @change='changeColor13'  v-model="paramValue.v_ParamValue4.color1" :disabled="true"></el-color-picker>
                  </span>
                  <span>
                    <el-color-picker size="small" :predefine="colorList" @change='changeColor14'  v-model="paramValue.v_ParamValue4.color2" :disabled="true"></el-color-picker>
                  </span>
                  <div id="deg-input">
                    <el-input v-model="paramValue.v_ParamValue4.deg" @change='changeColor15' placeholder="度数" :disabled="true"/>
                  </div>
        ...
        <div class="image-conBox" v-if="imageFlag">
          <el-row>
            <el-form-item label="值1" label-width="90px" prop="v_ParamValue">
              ...
              <el-col :span="10" :push="3">
                <div>
                  <el-input v-model="metaForm.v_ParamValue" @change="changeImage" disabled/>
                  <el-image
                    class="image-box"
          ...
          <el-row>
            <el-form-item label="值2" label-width="90px">
              ...
              <el-col :span="10" :push="3">
                <div>
                  <el-input v-model="metaForm.v_ParamValue1" @change="changeImage1" disabled/>
                  <el-image
                    class="image-box"
          ...
          <el-row>
            <el-form-item label="值3" label-width="90px">
              ...
              <el-col :span="10" :push="3">
                <div>
                  <el-input v-model="metaForm.v_ParamValue2" @change="changeImage2" disabled/>
                  <el-image
                    class="image-box"
          ...
          <el-row>
            <el-form-item label="值4" label-width="90px">
              ...
              <el-col :span="10" :push="3">
                <div>
                  <el-input v-model="metaForm.v_ParamValue3" @change="changeImage3" disabled/>
                  <el-image
                    class="image-box"
          ...
          <el-row>
            <el-form-item label="值5" label-width="90px">
              ...
              <el-col :span="10" :push="3">
                <div>
                  <el-input v-model="metaForm.v_ParamValue4" @change="changeImage4" disabled/>
                  <el-image
                    class="image-box"
        ...
        <div class="image-conBox" v-if="styleFlag">
          <el-row>
            <el-form-item label="值1" label-width="90px" prop="v_ParamValue">
              ...
              <el-col :span="10" :push="3">
                <div>
                  <el-input v-model="metaForm.v_ParamValue" disabled/>
          ...
          <el-row>
            <el-form-item label="值2" label-width="90px">
              ...
              <el-col :span="10" :push="3">
                <div>
                  <el-input v-model="metaForm.v_ParamValue1" disabled/>
          ...
          <el-row>
            <el-form-item label="值3" label-width="90px">
              ...
              <el-col :span="10" :push="3">
                <div>
                  <el-input v-model="metaForm.v_ParamValue2" disabled/>
          ...
          <el-row>
            <el-form-item label="值4" label-width="90px">
              ...
              <el-col :span="10" :push="3">
                <div>
                  <el-input v-model="metaForm.v_ParamValue3" disabled/>
          ...
          <el-row>
            <el-form-item label="值5" label-width="90px">
              ...
              <el-col :span="10" :push="3">
                <div>
                  <el-input v-model="metaForm.v_ParamValue4" disabled/>
...
export default {
  ...
  created () {
    ...
    if (confsBtn.operationcode === 'modify') {
      this.isDisable = true
      this.componentType.v_Code = formData.v_Code
  ...
  methods: {
    commit () {
      ...
      this.$refs.metaForm.validate(valid => {
        if (valid) {
          ...
          cgiService.tempParameterSaveData11(params).then(res => {
            if (res.code === 0) {
              this.formRed = false
              if (res.iId > 1) {
              ...
              let params = this.$store.state.paginations['CC_VW_parameterComponent']
    ...
    selectParentVal (code) {
      ...
      cgiService.getOneSysParameter(params).then(res => {
        if (res.code === 0) {
          ...
          this.sysMetaForm.v_ParamValue = data.v_ParamValue || undefined
          this.sysMetaForm.v_ParamValue1 = data.v_ParamValue1 || undefined
          this.sysMetaForm.v_ParamValue2 = data.v_ParamValue2 || undefined
          this.sysMetaForm.v_ParamValue3 = data.v_ParamValue3 || undefined
          this.sysMetaForm.v_ParamValue4 = data.v_ParamValue4 || undefined
    ...
    getParameterSysList (id) {
      let params = { i_BizID: id, i_EnableApiComponent: '1' }
