<!-- 批量添加系统参数自定查询 -->
<template>
<!-- 此组件用于参数组管理 中的 批量添加系统参数的自定义参数  搜索 -->
        ...
        <el-row>
          <el-col :span="6">
               <el-form-item  class="w-240" label-width="80px" label="参数编码">
                <el-input v-model="formSearch.v_ParamCode" placeholder="请输入参数编码" clearable></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="6">
               <el-form-item  class="w-240" label-width="70px" label="参数名称">
                <el-input v-model="formSearch.v_ParamName" placeholder="请输入参数名称" clearable></el-input>
            </el-form-item>
          </el-col>
...
export default {
  ...
  methods: {
    onSubmit () {
      ...
      let viewCode = 'CC_VW_batchAddParameter'
      // 传入查询的数据  到 mixins
