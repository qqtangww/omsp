...
<template>
  <div class="add-org-form">
    ...
    <el-form inline-message ref="metaForm" :model="metaForm" :rules="rules" label-width="100px" id="form-person-parameter">
      ...
      <div id="border-box">
            ...
            <el-form-item label="值1" label-width="90px" prop="v_ParamValue">
              ...
              <el-col :span="6" :push="3">
                <div>
                  <el-input
                    placeholder
                    :value="orgMetaForm.v_ParamValue === null ? '/' : orgMetaForm.v_ParamValue"
                    :disabled="true"
                  ></el-input>
                </div>
              </el-col>
            ...
            <el-form-item label="值2" label-width="90px">
              ...
              <el-col :span="6" :push="3">
                <div>
                  <el-input
                    placeholder
                    :value="orgMetaForm.v_ParamValue1 === null ? '/' : orgMetaForm.v_ParamValue1"
                    :disabled="true"
                  ></el-input>
                </div>
              </el-col>
            ...
            <el-form-item label="值3" label-width="90px">
              ...
              <el-col :span="6" :push="3">
                <div>
                  <el-input
                    placeholder
                    :value="orgMetaForm.v_ParamValue2 === null ? '/' : orgMetaForm.v_ParamValue2"
                    :disabled="true"
                  ></el-input>
                </div>
              </el-col>
            ...
            <el-form-item label="值4" label-width="90px">
              ...
              <el-col :span="6" :push="3">
                <div>
                  <el-input
                    placeholder
                    :value="orgMetaForm.v_ParamValue3 === null ? '/' : orgMetaForm.v_ParamValue3"
                    :disabled="true"
                  ></el-input>
                </div>
              </el-col>
            ...
            <el-form-item label="值5" label-width="90px">
              ...
              <el-col :span="6" :push="3">
                <div>
                  <el-input
                    placeholder
                    :value="orgMetaForm.v_ParamValue4 === null ? '/' : orgMetaForm.v_ParamValue4"
                    :disabled="true"
                  ></el-input>
                </div>
              </el-col>
            ...
            <el-form-item label="值1" label-width="90px" prop="v_ParamValue">
              ...
              <el-col :span="6" :push="3">
                <div>
                  <el-input-number
                    controls-position="right"
                    :value="orgMetaForm.v_ParamValue === '' ? undefined : orgMetaForm.v_ParamValue"
                    :min="Number(sysMetaForm.i_MinNumber)"
                    :max="Number(sysMetaForm.i_MaxNumber)"
                    label
                    :disabled="true"
            ...
            <el-form-item label="值2" label-width="90px">
              ...
              <el-col :span="6" :push="3">
                <div>
                  <el-input-number
                    controls-position="right"
                    :value="orgMetaForm.v_ParamValue1 === '' ? undefined : orgMetaForm.v_ParamValue1"
                    :min="Number(sysMetaForm.i_MinNumber)"
                    :max="Number(sysMetaForm.i_MaxNumber)"
                    label
                    :disabled="true"
            ...
            <el-form-item label="值3" label-width="90px">
              ...
              <el-col :span="6" :push="3">
                <div>
                  <el-input-number
                    controls-position="right"
                    :value="orgMetaForm.v_ParamValue2 === '' ? undefined : orgMetaForm.v_ParamValue2"
                    :min="Number(sysMetaForm.i_MinNumber)"
                    :max="Number(sysMetaForm.i_MaxNumber)"
                    label
                    :disabled="true"
            ...
            <el-form-item label="值4" label-width="90px">
              ...
              <el-col :span="6" :push="3">
                <div>
                  <el-input-number
                    controls-position="right"
                    :value="orgMetaForm.v_ParamValue3 === '' ? undefined : orgMetaForm.v_ParamValue3"
                    :min="Number(sysMetaForm.i_MinNumber)"
                    :max="Number(sysMetaForm.i_MaxNumber)"
                    label
                    :disabled="true"
            ...
            <el-form-item label="值5" label-width="90px">
              ...
              <el-col :span="6" :push="3">
                <div>
                  <el-input-number
                    controls-position="right"
                    :value="orgMetaForm.v_ParamValue4 === '' ? undefined : orgMetaForm.v_ParamValue4"
                    :min="Number(sysMetaForm.i_MinNumber)"
                    :max="Number(sysMetaForm.i_MaxNumber)"
                    label
                    :disabled="true"
        ...
        <div v-if="colorFlag" id="color-conBox">
          <el-row>
            <el-form-item label="值1" label-width="60px" prop="v_ParamValue">
              <el-col :span="8">
                <div>
              ...
              <el-col :span="8">
                <div>
                  <div id="colorval-input">
                    <el-input v-model="orgMetaForm.v_ParamValue" disabled/>
                  </div>
                  <div class="preview2-color1">
                    <i  class="el-icon-close"></i>
                  </div>
                </div>
              </el-col>
          ...
          <el-row>
            <el-form-item label="值2" label-width="60px">
              <el-col :span="8">
                <div>
                  <div id="colorval-input">
              ...
              <el-col :span="8">
                <div>
                  <div id="colorval-input">
                    <el-input :value="orgMetaForm.v_ParamValue1" disabled/>
                  </div>
                  <div class="preview2-color2">
                    <i  class="el-icon-close"></i>
                  </div>
                </div>
              </el-col>
          ...
          <el-row>
            <el-form-item label="值3" label-width="60px">
              <el-col :span="8">
                <div>
                  <div id="colorval-input">
              ...
              <el-col :span="8">
                <div>
                  <div id="colorval-input">
                    <el-input v-model="orgMetaForm.v_ParamValue2" disabled/>
                  </div>
                  <div class="preview2-color3">
                    <i  class="el-icon-close"></i>
                  </div>
                </div>
              </el-col>
          ...
          <el-row>
            <el-form-item label="值4" label-width="60px">
              <el-col :span="8">
                <div>
                  <div id="colorval-input">
              ...
              <el-col :span="8">
                <div>
                  <div id="colorval-input">
                    <el-input v-model="orgMetaForm.v_ParamValue3" disabled/>
                  </div>
                  <div class="preview2-color4">
                    <i  class="el-icon-close"></i>
                  </div>
                </div>
              </el-col>
          ...
          <el-row>
            <el-form-item label="值5" label-width="60px">
              <el-col :span="8">
                <div>
                  <div id="colorval-input">
              ...
              <el-col :span="8">
                <div>
                  <div id="colorval-input">
                    <el-input v-model="orgMetaForm.v_ParamValue4" disabled/>
                  </div>
                  <div class="preview2-color5">
                    <i  class="el-icon-close"></i>
                  </div>
                </div>
              </el-col>
              ...
              <el-col :span="8" :push="1">
                <div class="block">
                  <el-date-picker
                    class="dpicker"
                    value-format="yyyy-MM-dd"
                    v-model="orgMetaForm.v_ParamValue"
                    type="date"
                    :picker-options="pickerOptions"
                    placeholder="选择日期"
                    disabled>
              ...
              <el-col :span="8" :push="1">
                <div class="block">
                  <el-date-picker
                    class="dpicker"
                    value-format="yyyy-MM-dd"
                    v-model="orgMetaForm.v_ParamValue1"
                    type="date"
                    :picker-options="pickerOptions"
                    placeholder="选择日期"
                    disabled>
              ...
              <el-col :span="8" :push="1">
                <div class="block">
                  <el-date-picker
                    class="dpicker"
                    value-format="yyyy-MM-dd"
                    v-model="orgMetaForm.v_ParamValue2"
                    type="date"
                    :picker-options="pickerOptions"
                    placeholder="选择日期"
                    disabled>
              ...
              <el-col :span="8" :push="1">
                <div class="block">
                  <el-date-picker
                    class="dpicker"
                    value-format="yyyy-MM-dd"
                    v-model="orgMetaForm.v_ParamValue3"
                    type="date"
                    :picker-options="pickerOptions"
                    placeholder="选择日期"
                    disabled>
              ...
              <el-col :span="8" :push="1">
                <div class="block">
                  <el-date-picker
                    class="dpicker"
                    value-format="yyyy-MM-dd"
                    v-model="orgMetaForm.v_ParamValue4"
                    type="date"
                    :picker-options="pickerOptions"
                    placeholder="选择日期"
                    disabled>
        ...
        <div class="image-conBox" v-if="imageFlag">
          <el-row>
            <el-form-item label="值1" label-width="70px" prop="v_ParamValue">
              <el-col :span="8" :push="2">
                <div>
                  <textarea id="copy-sysSite1" v-model="sysMetaForm.v_ParamValue"></textarea>
                  <span :value='sysMetaForm.v_ParamValue' class="copy-sysSite1" @click="copySite('#copy-sysSite1')">复制地址</span>
                  <el-image
                    class="image-box"
              ...
              <el-col :span="8" :push="1">
                <div>
                  <textarea id="copy-orgSite1" v-model="orgMetaForm.v_ParamValue"></textarea>
                  <span :value='orgMetaForm.v_ParamValue' class="copy-orgSite1" @click="copySite('#copy-orgSite1')">复制地址</span>
                  <el-image
                    class="image-box"
                    :src="orgMetaForm.v_ParamValue"
                    :preview-src-list="orgSrcList">
                    <div slot="error" class="image-slot">
                      <i class="el-icon-picture-outline"></i>
                    </div>
                  </el-image>
          ...
          <el-row>
            <el-form-item label="值2" label-width="70px">
              <el-col :span="8" :push="2">
                <div>
                  <textarea id="copy-sysSite2" v-model="sysMetaForm.v_ParamValue1"></textarea>
                  <span :value='sysMetaForm.v_ParamValue1' class="copy-sysSite2" @click="copySite('#copy-sysSite2')">复制地址</span>
                  <el-image
                    class="image-box"
              ...
              <el-col :span="8" :push="1">
                <div>
                  <textarea id="copy-orgSite2" v-model="orgMetaForm.v_ParamValue1"></textarea>
                  <span :value='orgMetaForm.v_ParamValue1' class="copy-orgSite2" @click="copySite('#copy-orgSite2')">复制地址</span>
                  <el-image
                    class="image-box"
                    :src="orgMetaForm.v_ParamValue1"
                    :preview-src-list="orgSrcList1">
                    <div slot="error" class="image-slot">
                      <i class="el-icon-picture-outline"></i>
                    </div>
                  </el-image>
          ...
          <el-row>
            <el-form-item label="值3" label-width="70px">
              <el-col :span="8" :push="2">
                <div>
                  <textarea id="copy-sysSite3" v-model="sysMetaForm.v_ParamValue2"></textarea>
                  <span :value='sysMetaForm.v_ParamValue2' class="copy-sysSite3" @click="copySite('#copy-sysSite3')">复制地址</span>
                  <el-image
                    class="image-box"
              ...
              <el-col :span="8" :push="1">
                <div>
                  <textarea id="copy-orgSite3" v-model="orgMetaForm.v_ParamValue2"></textarea>
                  <span :value='orgMetaForm.v_ParamValue2' class="copy-orgSite3" @click="copySite('#copy-orgSite3')">复制地址</span>
                  <el-image
                    class="image-box"
                    :src="orgMetaForm.v_ParamValue2"
                    :preview-src-list="orgSrcList2">
                    <div slot="error" class="image-slot">
                      <i class="el-icon-picture-outline"></i>
                    </div>
                  </el-image>
          ...
          <el-row>
            <el-form-item label="值4" label-width="70px">
              <el-col :span="8" :push="2">
                <div>
                  <textarea id="copy-sysSite4" v-model="sysMetaForm.v_ParamValue3"></textarea>
                  <span :value='sysMetaForm.v_ParamValue3' class="copy-sysSite4" @click="copySite('#copy-sysSite4')">复制地址</span>
                  <el-image
                    class="image-box"
              ...
              <el-col :span="8" :push="1">
                <div>
                  <textarea id="copy-orgSite4" v-model="orgMetaForm.v_ParamValue3"></textarea>
                  <span :value='orgMetaForm.v_ParamValue3' class="copy-orgSite4" @click="copySite('#copy-orgSite4')">复制地址</span>
                  <el-image
                    class="image-box"
                    :src="orgMetaForm.v_ParamValue3"
                    :preview-src-list="orgSrcList3">
                    <div slot="error" class="image-slot">
                      <i class="el-icon-picture-outline"></i>
                    </div>
                  </el-image>
          ...
          <el-row>
            <el-form-item label="值5" label-width="70px">
              <el-col :span="8" :push="2">
                <div>
                  <textarea id="copy-sysSite5" v-model="sysMetaForm.v_ParamValue4"></textarea>
                  <span :value='sysMetaForm.v_ParamValue4' class="copy-sysSite5" @click="copySite('#copy-sysSite5')">复制地址</span>
                  <el-image
                    class="image-box"
              ...
              <el-col :span="8" :push="1">
                <div>
                  <textarea id="copy-orgSite5" v-model="orgMetaForm.v_ParamValue4"></textarea>
                  <span :value='orgMetaForm.v_ParamValue4' class="copy-orgSite5" @click="copySite('#copy-orgSite5')">复制地址</span>
                  <el-image
                    class="image-box"
                    :src="orgMetaForm.v_ParamValue4"
                    :preview-src-list="orgSrcList4">
                    <div slot="error" class="image-slot">
                      <i class="el-icon-picture-outline"></i>
                    </div>
                  </el-image>
            ...
            <el-form-item label="值1" label-width="90px" prop="v_ParamValue">
              ...
              <el-col :span="6" :push="3">
                <div>
                  <el-input
                    placeholder
                    :value="orgMetaForm.v_ParamValue === '' ? '/' : orgMetaForm.v_ParamValue"
                    disabled
                  ></el-input>
                </div>
              </el-col>
            ...
            <el-form-item label="值2" label-width="90px">
              ...
              <el-col :span="6" :push="3">
                <div>
                  <el-input
                    placeholder
                    :value="orgMetaForm.v_ParamValue1 === '' ? '/' : orgMetaForm.v_ParamValue1"
                    disabled
                  ></el-input>
                </div>
              </el-col>
            ...
            <el-form-item label="值3" label-width="90px">
              ...
              <el-col :span="6" :push="3">
                <div>
                  <el-input
                    placeholder
                    :value="orgMetaForm.v_ParamValue2 === '' ? '/' : orgMetaForm.v_ParamValue2"
                    disabled
                  ></el-input>
                </div>
              </el-col>
            ...
            <el-form-item label="值4" label-width="90px">
              ...
              <el-col :span="6" :push="3">
                <div>
                  <el-input
                    placeholder
                    :value="orgMetaForm.v_ParamValue3 === '' ? '/' : orgMetaForm.v_ParamValue3"
                    disabled
                  ></el-input>
                </div>
              </el-col>
            ...
            <el-form-item label="值5" label-width="90px">
              ...
              <el-col :span="6" :push="3">
                <div>
                  <el-input
                    placeholder
                    :value="orgMetaForm.v_ParamValue4 === '' ? '/' : orgMetaForm.v_ParamValue4"
                    disabled
                  ></el-input>
                </div>
              </el-col>
          ...
          <el-row>
            <el-form-item label="值1" label-width="70px" prop="v_ParamValue">
              <el-col :span="8" :push="3">
                <div>
                  <textarea id="copy-sysSite1" v-model="sysMetaForm.v_ParamValue"></textarea>
                  <span class="copy-sysSite1" @click="copySite('#copy-sysSite1')">复制类名</span>
              ...
              <el-col :span="8" :push="2">
                <div>
                  <textarea id="copy-orgSite1" v-model="orgMetaForm.v_ParamValue"></textarea>
                  <span class="copy-orgSite1" @click="copySite('#copy-orgSite1')">复制类名</span>
                  <span :class="['style-box',`${orgMetaForm.v_ParamValue}`]">样式</span>
                </div>
              </el-col>
              <el-col :span="8">
                <div>
          ...
          <el-row>
            <el-form-item label="值2" label-width="70px">
              <el-col :span="8" :push="3">
                <div>
                  <textarea id="copy-sysSite2" v-model="sysMetaForm.v_ParamValue1"></textarea>
                  <span class="copy-sysSite2" @click="copySite('#copy-sysSite2')">复制类名</span>
              ...
              <el-col :span="8" :push="2">
                <div>
                  <textarea id="copy-orgSite2" v-model="orgMetaForm.v_ParamValue1"></textarea>
                  <span class="copy-orgSite2" @click="copySite('#copy-orgSite2')">复制类名</span>
                  <span :class="['style-box',`${orgMetaForm.v_ParamValue1}`]">样式</span>
                </div>
              </el-col>
              <el-col :span="8">
                <div>
          ...
          <el-row>
            <el-form-item label="值3" label-width="70px">
              <el-col :span="8" :push="3">
                <div>
                  <textarea id="copy-sysSite3" v-model="sysMetaForm.v_ParamValue2"></textarea>
                  <span class="copy-sysSite3" @click="copySite('#copy-sysSite3')">复制类名</span>
              ...
              <el-col :span="8" :push="2">
                <div>
                  <textarea id="copy-orgSite3" v-model="orgMetaForm.v_ParamValue2"></textarea>
                  <span class="copy-orgSite3" @click="copySite('#copy-orgSite3')">复制类名</span>
                  <span :class="['style-box',`${orgMetaForm.v_ParamValue2}`]">样式</span>
                </div>
              </el-col>
              <el-col :span="8">
                <div>
          ...
          <el-row>
            <el-form-item label="值4" label-width="70px">
              <el-col :span="8" :push="3">
                <div>
                  <textarea id="copy-sysSite4" v-model="sysMetaForm.v_ParamValue3"></textarea>
                  <span class="copy-sysSite4" @click="copySite('#copy-sysSite4')">复制类名</span>
              ...
              <el-col :span="8" :push="2">
                <div>
                  <textarea id="copy-orgSite4" v-model="orgMetaForm.v_ParamValue3"></textarea>
                  <span class="copy-orgSite4" @click="copySite('#copy-orgSite4')">复制类名</span>
                  <span :class="['style-box',`${orgMetaForm.v_ParamValue3}`]">样式</span>
                </div>
              </el-col>
              <el-col :span="8">
                <div>
          ...
          <el-row>
            <el-form-item label="值5" label-width="70px">
              <el-col :span="8" :push="3">
                <div>
                  <textarea id="copy-sysSite5" v-model="sysMetaForm.v_ParamValue4"></textarea>
                  <span class="copy-sysSite5" @click="copySite('#copy-sysSite5')">复制类名</span>
              ...
              <el-col :span="8" :push="2">
                <div>
                  <textarea id="copy-orgSite5" v-model="orgMetaForm.v_ParamValue4"></textarea>
                  <span class="copy-orgSite5" @click="copySite('#copy-orgSite5')">复制类名</span>
                  <span :class="['style-box',`${orgMetaForm.v_ParamValue4}`]">样式</span>
                </div>
              </el-col>
              <el-col :span="8">
                <div>
...
export default {
  ...
  data () {
    ...
    return {
      ...
      rules: {
        ...
        v_ParamValue: [
          { required: true, message: '请输入个人参数值1', trigger: 'blur' }
        ]
      },
      formRed: false,
      noFlag: true,
  ...
  created () {
    ...
    let treeData = this.$store.state.fieTreeData['CC_TR_parmeter']
    this.getParameterSysList(treeData.i_BizID)
  ...
  methods: {
    commit () {
      ...
      this.$refs.metaForm.validate(valid => {
        if (valid) {
          ...
          cgiService.tempParameterSaveData4(params).then(res => {
            if (res.code === 0) {
              this.formRed = false
              if (res.iId > 1) {
              ...
              let params = this.$store.state.paginations['CC_VW_parameterUser']
    ...
    selectParentVal (code) {
      ...
      cgiService.getOneSysParameter(params).then(res => {
        if (res.code === 0) {
          ...
          this.getOneOrgParameter(res.data.v_ParamCode, this.metaForm.i_ParamValType, data.v_EnumCode)
    ...
    // 获取系统参数
    getParameterSysList (id) {
      let params = { i_BizID: id, i_EnableUser: '1' }
      cgiService.parameterSysList(params).then(res => {
        if (res.code === 0) {
    ...
    // 获取组织参数
    getOneOrgParameter (code, paramValType, enumCode) {
      let params = { v_ParamCode: code }
      cgiService.oneOrgParameter(params).then(res => {
        if (res.code === 0) {
          let data = res.data
          this.orgMetaForm.v_ParamValue = data.v_ParamValue
          this.orgMetaForm.v_ParamValue1 = data.v_ParamValue1
          this.orgMetaForm.v_ParamValue2 = data.v_ParamValue2
          this.orgMetaForm.v_ParamValue3 = data.v_ParamValue3
          this.orgMetaForm.v_ParamValue4 = data.v_ParamValue4
          if (enumCode === '') {
            if (paramValType === 'colorBlocks') {
              let val1, val2, val3, val4, val5
              if (!data.v_ParamValue) {
                val1 = ['', '', '']
              } else {
                val1 = data.v_ParamValue.split(' ')
              }
              if (!data.v_ParamValue1) {
                val2 = ['', '', '']
              } else {
                val2 = data.v_ParamValue1.split(' ')
              }
              if (!data.v_ParamValue2) {
                val3 = ['', '', '']
              } else {
                val3 = data.v_ParamValue2.split(' ')
              }
              if (!data.v_ParamValue3) {
                val4 = ['', '', '']
              } else {
                val4 = data.v_ParamValue3.split(' ')
              }
              if (!data.v_ParamValue4) {
                val5 = ['', '', '']
              } else {
                val5 = data.v_ParamValue4.split(' ')
              }

              this.colorPreview(val1[0], val1[1], val1[2], '.preview2-color1')
              this.colorPreview(val2[0], val2[1], val2[2], '.preview2-color2')
              this.colorPreview(val3[0], val3[1], val3[2], '.preview2-color3')
              this.colorPreview(val4[0], val4[1], val4[2], '.preview2-color4')
              this.colorPreview(val5[0], val5[1], val5[2], '.preview2-color5')
            }
            if (paramValType === 'Img') {
              this.orgSrcList.push(data.v_ParamValue)
              this.orgSrcList1.push(data.v_ParamValue1)
              this.orgSrcList2.push(data.v_ParamValue2)
              this.orgSrcList3.push(data.v_ParamValue3)
              this.orgSrcList4.push(data.v_ParamValue4)
            }
          }
        }
      })
