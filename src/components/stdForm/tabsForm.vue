 ...
 * @LastEditTime: 2019-08-19 16:15:52
...
<template>
  ...
  <div class="bodyBorderBox">
    <!-- 内容组件 -->
    <component :is="routeName"  :configData="formConfigData" @closeDialog='closeDialog' @getTableData='getTableData' @getButtonConfig='closeFun' :shareData="shareData" @getData='getData' @changeData='changeData' @changeShareData='changeShareData' @handleClick='handleClick'></component>
  </div>
</template>
